...
//    public static AdminUserDTO adminUserDTO = new AdminUserDTO(1L,"John", "Smith", "jsmith@email.com", null, null, "123456798", null);
//    public static List<AdminUserDTO> adminUserDTOList = new ArrayList(List.of(adminUserDTO));

    public static User user = new User(1L, "John", "Smith", "jsmith@email.com", "admin", null, null, "123456798");
    public static UserDTO UserDTO = new UserDTO("John", "Smith", "jsmith@email.com", "admin", null, null, null);
    ...
    public static List<CategoryDTO> categoryDTOList = new ArrayList<>(Collections.singletonList(categoryDTO));
    ...
    public static PageOfProductsDTO<List<ProductDTO>> pageOfProductDTO = new PageOfProductsDTO<>(productDtoList, true, 15);
}
